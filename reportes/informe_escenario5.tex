...
\begin{itemize}
    ...
    \item Las \textbf{cuatro tareas de Prioridad 1} (Registro HCE, Agendamiento, Facturaci\'on y Administraci\'on de medicamentos) concentran el 66.6\% del volumen total de incidentes reportados en 2025, validando emp\'iricamente la priorizaci\'on.
